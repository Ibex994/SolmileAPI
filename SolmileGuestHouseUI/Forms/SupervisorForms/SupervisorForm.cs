...
namespace SolmileGuestHouseUI.Forms.SupervisorForms
{
    public partial class SupervisorForm : Form
    {
        ...
        public SupervisorForm()
        {
            ...
            {
                BaseAddress = new Uri("https://yourapiurl.com/") // replace with actual base URL
            };
        }
        ...
        private void btnComplaint_Click_1(object sender, EventArgs e)
        {
            OpenChildForm(new Complaint(), sender);
        }

        private void btnServiceRequest_Click_1(object sender, EventArgs e)
        {
            OpenChildForm(new ServiceRequest(), sender);
        }

        private void btnTask_Click_1(object sender, EventArgs e)
        {
            OpenChildForm(new TaskManagement(), sender);
        }
